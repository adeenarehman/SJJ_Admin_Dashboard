...
// import * as physicalAppointmentAction from '../../../Redux/Actions/action';
...
export default function PhysicalAppointmentTable() {

  // const dispatch = useDispatch();
  // const {physicalappointment} = useSelector(state => state.physicalappointment);

  // useEffect(() => {
  //   dispatch(physicalAppointmentAction.fetchPhysicalAppointments());
  // }, [dispatch])
...
function CustomNoRowsOverlay() {
  ...
  function stringAvatar(name) {
    ...
    //APPOINTMENTS ROW DATA
const rows = physicalappointment.filter((val) => {
  if (search == '') {
    return val
  }
  ...
  return {
    ...
    const columns = [
      ...
      },
      {
        ...
        valueFormatter: (params) => {
          const valueFormatted = params.value.paymentStatus;
  ...
  return (
    // console.log('New Array K kam ka bad : ', hospData),
