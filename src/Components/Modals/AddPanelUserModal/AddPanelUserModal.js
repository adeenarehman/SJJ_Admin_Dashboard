                                ...
                                <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none', height: '100%' }}>
                                    ...
                                    <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                                        ...
                                        <Typography variant='body2' style={{ fontWeight: 'bold' }}>First Name: </Typography>
                                            <TextField value={userFirstName} onChange={e => setUserFirstName(e.target.value)} style={{ width: '100%' }} size='small' id="outlined-basic" label="First Name..." variant="filled" />
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={12} lg={6} xl={6} style={{ backgroundColor: 'none', marginTop:'2%' }}>
                                        <Typography variant='body2' style={{ fontWeight: 'bold' }}>Last Name: </Typography>
                                            <TextField style={{ width: '100%' }} value={userLastName} onChange={e => setUserLastName(e.target.value)} size='small' id="outlined-basic" label="Last Name..." variant="filled" />
                                        </Grid>
                                    </Grid>
                                    ...
                                    <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                                        ...
                                        <Typography variant='body2' style={{ fontWeight: 'bold' }}>Email: </Typography>
                                            <TextField style={{ width: '100%' }} value={userEmail} onChange={e => setUserEmail(e.target.value)} size='small' id="outlined-basic" label="Email..." variant="filled" />
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={12} lg={6} xl={6} style={{ marginTop:'2%' }}>
                                        <Typography variant='body2' style={{ fontWeight: 'bold' }}>Password: </Typography>
                                            <TextField style={{ width: '100%' }} value={userPassword} onChange={e => setUserPassword(e.target.value)} size='small' id="outlined-basic" label="Password..." variant="filled" />
                                        </Grid>
                                    </Grid>
                                    ...
                                    <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                                        ...
                                        <Typography variant='body2' style={{ fontWeight: 'bold' }}>City: </Typography>
                                            <TextField style={{ width: '100%' }} value={userCity} onChange={e => setUserCity(e.target.value)} size='small' id="outlined-basic" label="City..." variant="filled" />
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={12} lg={6} xl={6} style={{ marginTop:'2%' }}>
                                        <Typography variant='body2' style={{ fontWeight: 'bold' }}>Country: </Typography>
                                            <TextField style={{ width: '100%' }} value={userCountry} onChange={e => setUserCountry(e.target.value)} size='small' id="outlined-basic" label="Country..." variant="filled" />
                                        </Grid>
                                    </Grid>
