  ...
  const handleSubmit = (event) => { {/** FORM DATA SET FUNCTION **/}
    ...
    //   hospImageUrl,userId,hospPublishTime,hospPublishDate));
      ...
      handleSuccessClick(); {/* Success SnackBar Function */ } 
          ...
          setIsLoading(false)
          setHospName(''); setHospContact(''); setHospAddress(''); setHospCity(''); setHospCountry(''); setHospLat(''); setHospLng('');
          setHospHomeService('');
  }
  ...
  return (
    ...
    <Grid container>
            ...
            <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                ...
                <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                  ...
                  <Typography variant='body2' style={{ fontWeight: 'bold' }}>Name: </Typography>
                    <TextField required style={{ width: '100%' }} value={hospName} onChange={e => setHospName(e.target.value)} size='small' id="outlined-basic" label="Name..." variant="filled" />
                  </Grid>
                  <Grid item xs={12} sm={12} md={12} lg={6} xl={6} style={{ marginTop:'2%' }}>
                  <Typography variant='body2' style={{ fontWeight: 'bold' }}>Contact: </Typography>
                    <TextField required style={{ width: '100%' }} value={hospContact} onChange={e => setHospContact(e.target.value)} size='small' id="outlined-basic" label="Contact..." variant="filled" />
                  </Grid>
                </Grid>
                {/* ADDRESS CONTAINER */}
                <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                  ...
                  <Typography variant='body2' style={{ fontWeight: 'bold' }}>Address: </Typography>
                    <TextField required style={{ width: '100%' }} value={hospAddress} onChange={e => setHospAddress(e.target.value)} size='small' id="outlined-basic" label="Address..." variant="filled" />
                  </Grid>
                  <Grid item xs={12} sm={12} md={12} lg={6} xl={6} style={{ marginTop:'2%' }}>
                  <Typography required variant='body2' style={{ fontWeight: 'bold' }}>Home Service: </Typography>                                        <FormControl fullWidth size='small' variant="filled">
                ...
                <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                  ...
                  <Typography variant='body2' style={{ fontWeight: 'bold' }}>City: </Typography>
                    <TextField required style={{ width: '100%' }} value={hospCity} onChange={e => setHospCity(e.target.value)} size='small' id="outlined-basic" label="City..." variant="filled" />
                  </Grid>
                  <Grid item xs={12} sm={12} md={12} lg={6} xl={6} style={{ marginTop:'2%' }}>
                  <Typography variant='body2' style={{ fontWeight: 'bold' }}>Country: </Typography>
                    <TextField required style={{ width: '100%' }} value={hospCountry} onChange={e => setHospCountry(e.target.value)} size='small' id="outlined-basic" label="Country..." variant="filled" />
                  </Grid>
                </Grid>
                {/* LAT & LNG CONTAINER */}
                <Grid container rowSpacing={1} columnSpacing={1} style={{ backgroundColor: 'none' }}>
                  ...
                  <Typography variant='body2' style={{ fontWeight: 'bold' }}>Latitude: </Typography>
                    <TextField required style={{ width: '100%' }} value={hospLat} onChange={e => setHospLat(e.target.value)} size='small' id="outlined-basic" label="Latitude..." variant="filled" />
                  </Grid>
                  <Grid item xs={12} sm={12} md={12} lg={6} xl={6} style={{ marginTop:'2%' }}>
                  <Typography variant='body2' style={{ fontWeight: 'bold' }}>Longitude: </Typography>
                    <TextField required style={{ width: '100%' }} value={hospLng} onChange={e => setHospLng(e.target.value)} size='small' id="outlined-basic" label="Longitude..." variant="filled" />
                  </Grid>
                </Grid>
      ...
      <Snackbar open={openSuccess} anchorOrigin={{ vertical, horizontal }} autoHideDuration={3000} onClose={handleSuccessClose}>
                <Alert severity="success" variant='filled' onClose={handleSuccessClose}>Hospital Has Been Added Successfully!</Alert>
            </Snackbar>

            <Snackbar open={openError} anchorOrigin={{ vertical, horizontal }} autoHideDuration={3000} onClose={handleErrorClose}>
                <Alert severity="error" variant='filled' onClose={handleErrorClose}>Hospital Has Not Been Added!</Alert>
            </Snackbar>
            {/* -------------------------------------------------------------------------------------------------------------- */}
    </Grid>
    </ThemeProvider>
